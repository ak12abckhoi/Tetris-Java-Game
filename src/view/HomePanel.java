...
/**
 * HomePanel — Màn hình Menu chính của game.
 *
 * Hiển thị logo "TETRIS" với từng chữ cái mang màu neon riêng
 * và các nút điều hướng tới các màn hình khác.
 */
public class HomePanel extends JPanel {
    ...
    /**
     * Tạo nút Menu với nền glassmorphism, viền neon và hiệu ứng glow khi hover.
     */
    ...
    /**
     * Vẽ logo "TETRIS" với mỗi chữ cái mang màu neon riêng và hiệu ứng glow nhỏ.
     * Dòng sáng gradient bên dưới logo tạo điểm nhấn thẩm mỹ.
     */
    private void drawLogo(Graphics2D g2d) {
        String title  = "TETRIS";
        Color[] colors = {
            NeonTheme.PINK, NeonTheme.CYAN, NeonTheme.YELLOW,
            NeonTheme.LIME, NeonTheme.PURPLE, NeonTheme.ORANGE
        };

        // Thu nhỏ logo để vừa cửa sổ 400×650
        ...
        // Đường sáng gradient phía dưới logo
        g2d.setPaint(new GradientPaint(
            getWidth() / 4, y + 8,
            new Color(NeonTheme.CYAN.getRed(), NeonTheme.CYAN.getGreen(), NeonTheme.CYAN.getBlue(), 0),
            getWidth() / 2, y + 8,
            NeonTheme.CYAN, true
        ));
